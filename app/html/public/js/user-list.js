...
async function sendData(data) {
    try {
        let responseObject = await fetch("/api/update-user", {
            method: 'POST',
            headers: {
...
async function sendDataToDelete(e) {
    ...
    document.getElementById("confirm").addEventListener("click", async function () {
        ...
        try {
            let responseObject = await fetch("/api/delete-user", {
                method: 'POST',
                headers: {
                    "Accept": 'application/json',
                    "Content-Type": 'application/json'
...
async function sendDataToMakeUser(e) {
    ...
    document.getElementById("confirm").addEventListener("click", async function () {
        ...
        try {
            let responseObject = await fetch("/api/make-user", {
                method: 'POST',
                headers: {
                    "Accept": 'application/json',
                    "Content-Type": 'application/json'
...
async function sendDataToMakeAdmin(e) {
    ...
    document.getElementById("confirm").addEventListener("click", async function () {
        ...
        try {
            let responseObject = await fetch("/api/make-admin", {
                method: 'POST',
                headers: {
                    "Accept": 'application/json',
                    "Content-Type": 'application/json'
